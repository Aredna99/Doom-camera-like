...
public class CameraFacingBillboard : MonoBehaviour
{
	...
	void Update()
	{
        ...
        targetDirection = cam.transform.forward - transform.position;
        angle = Vector3.Dot(targetDirection, transform.forward);
        //Debug.Log(transform.rotation.eulerAngles.y);
        //Debug.Log(camPar.transform.rotation.eulerAngles);
        //Debug.Log(cam.transform.parent.transform.rotation.y);
